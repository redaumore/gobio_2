...
const MenuMobileCollapsed2: FunctionComponent<MenuMobileCollapsed2Type> = ({
  ...
  return (
    <div
      className={`w-[360px] h-full relative bg-gray-200 overflow-hidden [&.animate]:animate-[0.25s_ease_0s_1_normal_forwards_slide-in-left] opacity-[0] max-w-[90%] text-left text-base text-grays-white font-montserrat ${className}`}
      data-animate-on-scroll
    >
      ...
      <div
        className="absolute top-[0px] left-[0px] bg-gray-200 w-[360px] flex flex-row items-center justify-end py-3 px-4 box-border cursor-pointer"
        onClick={onClose}
      >
