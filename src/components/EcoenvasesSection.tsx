...
const EcoenvasesSection: React.FC = () => {
  ...
  return (
    <section className='flex justify-center'>
      <div className="w-full max-w-1440 py-12">
        <h2 className="xs:text-3xl sm:text-2xl md:text-3xl mb-2 font-light px-4">Ecoenvases</h2>
        <p className="text-xl xs:text-4xl sm:text-4xl mb-8 mt-2 font-medium lg:max-w-lg px-4">
