...
export type HeaderGobio1Type = {
  className?: string;
};

const HeaderGobio1: FunctionComponent<HeaderGobio1Type> = ({
  className = "",
}) => {
  ...
  return (
    <>
      <div
        className={`w-[1440px] bg-gray-200 max-w-full flex flex-row items-start justify-between py-0 px-6 box-border text-left text-sm text-grays-white font-montserrat ${className}`}
      >
        <img
