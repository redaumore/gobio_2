...
const ProductPage: FunctionComponent<ProductProps> = ({name, family, material, size, pack, observations, images}) => {
  return (
    <div className="min-h-screen font-montserrat bg-gray-100">
      ...
      <div className="max-w-1440 mx-auto rounded-2xl bg-white">
        <div className="flex flex-col md:flex-row gap-6 px-6 py-10">
          ...
          <div className="md:w-1/2">
            ...
            <div className="hidden mb-4 md:flex md:flex-col xl:flex-row">
              <div className="mb-2 order-1 xl:order-2">
                <div className="inline-flex border-gradient">
                  <div className="flex-shrink-0 text-sm bg-white text-gray-800 font-bold border-gradient-content ">
                    100% Biodegradable
                  </div>
                </div>
              </div>
              <div className="order-2 xl:order-1 xl:w-2/3">
